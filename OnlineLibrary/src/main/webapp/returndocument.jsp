...
<body>
	...
	String query = "select * from copy c, borrow b, reader r, documents d where c.copy_id = b.borrow_copy_id and b.borrow_reader_id = r.reader_id and d.doc_id = c.copy_doc_id and copy_is_borrowed=1 and b.return_date_time is null";
	...
	<% 	}
		...
		while(rs.next())
		{
			...
			<p> Doc ID : <strong><%= rs.getString("copy_doc_id") %></strong>
				...
				<br>Borrowed on : <strong><%= rs.getDate("borrow_date_time") %></strong>
				&emsp;&emsp;&emsp;Return by : <strong><%= rs.getDate("expected_return")%></strong>
				...
				&emsp;&emsp;&emsp;<input type = "submit" value ="Return" /></p>
